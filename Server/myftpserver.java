...
public class myftpserver {
    ...
    private static HashMap<String, Boolean> isTerminated = new HashMap<>();
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            ClientHandler clientHandler = new ClientHandler(isClient, clientSock, commandTable, isTerminated);
            clientHandler.start();
            ClientHandler tHandler = new ClientHandler(isClient, tSock, commandTable, isTerminated);
            tHandler.start();
        }
